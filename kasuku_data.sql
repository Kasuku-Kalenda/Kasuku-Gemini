...
\restrict 05bzzI92BQQIZf4wiCPfwvfY1GGM0wp7JpKLct7LNxz6JdlfjXIMg2HrQBeFT31
...
ALTER TABLE public.event_media DISABLE TRIGGER ALL;
...
ALTER TABLE public.event_media ENABLE TRIGGER ALL;
...
ALTER TABLE public.event_modules DISABLE TRIGGER ALL;

COPY public.event_modules (event_id, module_id) FROM stdin;
\.


ALTER TABLE public.event_modules ENABLE TRIGGER ALL;
...
ALTER TABLE public.event_revisions ENABLE TRIGGER ALL;

--
-- Data for Name: themes; Type: TABLE DATA; Schema: public; Owner: kasuku
--

ALTER TABLE public.themes DISABLE TRIGGER ALL;
...
ALTER TABLE public.themes ENABLE TRIGGER ALL;

--
-- Data for Name: event_themes; Type: TABLE DATA; Schema: public; Owner: kasuku
--

ALTER TABLE public.event_themes DISABLE TRIGGER ALL;
...
ALTER TABLE public.event_themes ENABLE TRIGGER ALL;
...
ALTER TABLE public.featured_items DISABLE TRIGGER ALL;
...
ALTER TABLE public.featured_items ENABLE TRIGGER ALL;

--
-- Data for Name: kalendas; Type: TABLE DATA; Schema: public; Owner: kasuku
--

ALTER TABLE public.kalendas DISABLE TRIGGER ALL;
...
ALTER TABLE public.taggables DISABLE TRIGGER ALL;

COPY public.taggables (tag_id, entity_type, entity_id) FROM stdin;
\.


ALTER TABLE public.taggables ENABLE TRIGGER ALL;

--
-- Data for Name: translations; Type: TABLE DATA; Schema: public; Owner: kasuku
--

ALTER TABLE public.translations DISABLE TRIGGER ALL;

COPY public.translations (entity_type, entity_id, lang, field, value, status, translated_by, translated_at) FROM stdin;
\.


ALTER TABLE public.translations ENABLE TRIGGER ALL;

--
-- PostgreSQL database dump complete
--

\unrestrict 05bzzI92BQQIZf4wiCPfwvfY1GGM0wp7JpKLct7LNxz6JdlfjXIMg2HrQBeFT31
