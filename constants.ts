...
export let TIMELINES: TimelineNarrative[] = [
  {
    ...
    type: 'evenement',
    summary: "Plongez dans l'histoire de l'Afrique Occidentale Française, de sa création administrative à son héritage monétaire.",
    coverUrl: 'https://picsum.photos/seed/aof-story/800/600',
  ...
  },
  {
    ...
    title: 'Samuel Eto\'o',
    type: 'personnage',
    summary: 'De Douala aux sommets de l\'Europe, revivez la trajectoire légendaire du Lion Indomptable.',
    coverUrl: 'https://images.unsplash.com/photo-1574629810360-7efbbe195018?q=80&w=800',
  ...
  },
  {
    ...
    type: 'personnage',
    summary: 'Suivez le destin de Madiba, de la lutte clandestine à la présidence d\'une nation réconciliée.',
    coverUrl: 'https://images.unsplash.com/photo-1581338834647-b0fb40704e21?q=80&w=800',
