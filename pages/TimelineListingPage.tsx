...
export const TimelineListingPage: React.FC<TimelineListingPageProps> = ({ onSelectTimeline }) => {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-10 pb-24 px-4 pt-4">

      {/* ── Header ──────────────────────────────────────────────────────────── */}
      <header className="space-y-5 text-center sm:text-left max-w-2xl">
        ...
        <h1 className="text-4xl md:text-6xl font-black text-secondary leading-[1.1] tracking-tight">
          Bibliothèque de <br />
          <span className="text-primary">Récits</span>
        </h1>
        <p className="text-dark/60 text-base md:text-lg font-medium leading-relaxed">
              ...
              {filtered.map(tl => (
                ...
                >
                  ...
                  <div className="space-y-3 px-2">
                    ...
                    <h3 className="text-2xl sm:text-3xl font-black text-secondary group-hover:text-primary transition-colors leading-tight">
                      {tl.title}
                    </h3>
                    <p className="text-dark/70 text-sm leading-relaxed line-clamp-3 font-medium">{tl.shortDescription}</p>
                    <div className="pt-3">
                      <span className="inline-flex items-center gap-2 rounded-full px-8 py-4 border border-secondary/10 hover:border-primary/40 hover:bg-primary/5 text-secondary hover:text-primary font-black text-[11px] uppercase tracking-[0.2em] transition-all group-hover:translate-x-2 cursor-pointer">
                        Lancer le parcours →
                      </span>
                    </div>
                  </div>
